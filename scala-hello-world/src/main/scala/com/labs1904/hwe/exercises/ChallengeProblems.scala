...
object ChallengeProblems extends App {
  /**
  ...
  */
  ...
  Returns - Int
   */
  def listSize(myList: List[Int]): Int = {
    myList.size
  }
  ...
  /**
   ...
   Returns - List[String]
*/
  def upper(myList: List[String]): List[String] = {
    myList.map(x => x.toUpperCase())
  }
  ...
  Returns - List[Int]
   */
  def filterNegatives(myList: List[Int]): List[Int] = {
    myList.filter(x => x >= 0)
  }
  ...
  Returns - List[String]
 */
  def containsCar(myList: List[String]): List[String] = {
    myList.filter(x => x.contains("car"))
  }
 ...
 */
  ...
  Returns - Int
   */
  def minimum(myList: List[Int]): Int = {
    myList.min
  }
 ...
 */
  def minimumOption(myList: List[Option[Int]]): Option[Int] = {
    myList.sorted.head
  }
